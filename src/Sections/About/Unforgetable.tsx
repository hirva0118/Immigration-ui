...
const Unforgetable = () => {
  return (
    <div className="container relative pb-8 md:pb-[120px] overflow-hidden">
      <div className="rounded-3xl border border-borderGray  bg-white max-w-full overflow-hidden bg-[url('/wave1.png')] bg-blend-overlay bg-white/90">
        <div className="flex items-center flex-col">
          <div className="flex gap-[10px] pt-14 lg:pt-[120px] ">
            <CardGreen />
            <p className="text-darkGReen">PROCESS OVERVIEW</p>
          </div>
          <p className="max-w-[630px] text-3xl md:text-[50px] font-bold font-jakarta text-center text-darkGReen md:leading-[3.5rem] px-4 md:px-0">
            Unforgettable Getaways Escaping Routine{" "}
          </p>
          <div className="contain w-full flex flex-col md:flex-row xl:gap-[30px] ">
            <div className="flex flex-col w-full py-[30px] pl-[40px] max-w-[410px] mt-[60px] bg-white z-10">
            ...
            <div className="flex flex-col w-full  py-[30px] pl-[40px] max-w-[410px] md:mt-[100px] md:mb-[120px] bg-white z-10">
              <div className=" pb-[10px]">
                <ZeroTwo />
              </div>
              <p className="pb-5 text-darkGReen text-[22px] font-bold font-jakarta">
            ...
            <div className="flex flex-col w-full py-[30px] pl-[40px] max-w-[410px] md:mt-[60px] bg-white z-10 pr-8 xl:pr-0">
              <div className=" pb-[10px]">
                <ZeroThree />
              </div>
              <p className="pb-5 text-darkGReen text-[22px] font-bold font-jakarta">

...
const DreamDestination = () => {
  return (
    <section className="sm:contain ">
      <div className="pb-14 sm:pb-[120px] flex flex-col xl:flex-row xl:gap-8 2xl:gap-20">
        <div className="flex gap-8 px-4 sm:px-0 mx-auto sm:max-w-[580px]">
          <div className="hidden  relative sm:flex flex-col gap-[49px] items-center">
            <img
              className=" h-[250px] sm:h-[360px] max-w-full sm:max-w-[268px] rounded-xl"
              alt="home"
              src={Images.home1}
            />
          ...
          <div className="flex flex-col gap-[23px]">
            <div className="max-w-full sm:max-w-[282px] h-24 sm:h-[128px] bg-lightGreen rounded-xl py-9 px-11 flex gap-5 items-center text-white">
              <p className="text-[50px] font-jakarta">25</p>
              <p className="font-jakarta">Years of Experience</p>
            </div>
            <div>
              <img
        ...
        <div className="flex flex-col pt-10 xl:pt-0 px-4 sm:px-14 xl:px-0 max-w-full mx-auto xl:max-w-[630px]">
          <div className="pb-[25px]">
            ...
            <p className=" text-black font-bold text-2xl sm:text-[50px] pb-5 font-jakarta leading-10 sm:leading-[3.5rem]">
              ...
              <span className="text-darkGReen font-jakarta">
                Dream Destinations
              </span>{" "}
            </p>
          ...
          <div className="flex flex-col sm:flex-row gap-[30px] pb-10">
            ...
            <div className="max-w-full sm:max-w-[300px] sm:w-full px-7 border pt-8 pb-6 border-borderGray rounded-2xl">
              <div className="flex gap-5 items-center pb-5">
                <div className="bg-lightGreen w-[60px] h-[60px] p-4  rounded-full">
                  <HomeDiv5 className="" />
                </div>
                <p className="text-darkGReen font-bold text-[22px] font-jakarta">
                  Global Entry
          ...
          <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-10">
            <Button
              className="px-7 py-4 text-darkGReen border border-lightGreen font-jakarta font-semibold text-sm"
              variant="none"
              type="button"
            ...
            <div className="flex gap-[15px]">
              ...
              <div className="flex flex-col text-darkGReen">
                <p className="text-base font-jakarta">Need help?</p>
                <p className="text-lg font-jakarta cursor-pointer">(808) 555-0111</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div
        className="flex flex-row flex-wrap items-center gap-5 md:justify-between 
      pb-[120px] px-8 sm:px-14 2xl:px-0"
      >
        <Segment className="cursor-pointer" />
        <Splunk className="cursor-pointer" />
        <Hubspot className="cursor-pointer" />
        <Asana className="cursor-pointer" />
        <Airtasker className="cursor-pointer" />
      </div>
    </section>
  );
};
